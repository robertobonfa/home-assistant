#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Neon a partire dalla stessa composizione di neon-bg.svg.
Generates the Neon background PNGs from the same composition as neon-bg.svg.
...
OUT = [
    ("neon-bg-2560x1440.png", 2560, 1440),
    ("neon-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Neon
SKY_TOP = hexrgb("#0b021d")
SKY_MID = hexrgb("#0d0221")
SKY_BOT = hexrgb("#28074c")
GLOW = hexrgb("#a319c4")
COUNTERGLOW = hexrgb("#e01e84")
RIDGE_1_TOP = hexrgb("#260749")
RIDGE_1_BOT = hexrgb("#1e053c")
RIDGE_2 = hexrgb("#2b0852")
EDGE = hexrgb("#6a0dad")
VIGNETTE = hexrgb("#080115")
