#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Uva a partire dalla stessa composizione di uva-bg.svg.
Generates the Uva background PNGs from the same composition as uva-bg.svg.
...
OUT = [
    ("uva-bg-2560x1440.png", 2560, 1440),
    ("uva-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Uva
SKY_TOP = hexrgb("#1a0920")
SKY_MID = hexrgb("#1e0a24")
SKY_BOT = hexrgb("#331143")
GLOW = hexrgb("#8236b5")
COUNTERGLOW = hexrgb("#a855d8")
RIDGE_1_TOP = hexrgb("#321041")
RIDGE_1_BOT = hexrgb("#2c0e38")
RIDGE_2 = hexrgb("#361247")
EDGE = hexrgb("#5e2382")
VIGNETTE = hexrgb("#140617")
