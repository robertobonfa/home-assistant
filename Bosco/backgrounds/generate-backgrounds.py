#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Bosco a partire dalla stessa composizione di bosco-bg.svg.
Generates the Bosco background PNGs from the same composition as bosco-bg.svg.
...
OUT = [
    ("bosco-bg-2560x1440.png", 2560, 1440),
    ("bosco-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Bosco
SKY_TOP = hexrgb("#071912")
SKY_MID = hexrgb("#081c15")
SKY_BOT = hexrgb("#153729")
GLOW = hexrgb("#40916c")
COUNTERGLOW = hexrgb("#52b788")
RIDGE_1_TOP = hexrgb("#143528")
RIDGE_1_BOT = hexrgb("#112e22")
RIDGE_2 = hexrgb("#173b2c")
EDGE = hexrgb("#2d6a4f")
VIGNETTE = hexrgb("#05120e")
