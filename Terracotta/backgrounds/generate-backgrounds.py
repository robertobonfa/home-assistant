#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Terracotta a partire dalla stessa composizione di terracotta-bg.svg.
Generates the Terracotta background PNGs from the same composition as terracotta-bg.svg.
...
OUT = [
    ("terracotta-bg-2560x1440.png", 2560, 1440),
    ("terracotta-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Terracotta
SKY_TOP = hexrgb("#262838")
SKY_MID = hexrgb("#3d405b")
SKY_BOT = hexrgb("#4a3c4c")
GLOW = hexrgb("#c96a52")
COUNTERGLOW = hexrgb("#e07a5f")
RIDGE_1_TOP = hexrgb("#5c4656")
RIDGE_1_BOT = hexrgb("#534457")
RIDGE_2 = hexrgb("#634855")
EDGE = hexrgb("#9c544d")
VIGNETTE = hexrgb("#282a3b")
