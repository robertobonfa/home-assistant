...
- Tema `terracotta.yaml` per Home Assistant, 185 variabili, interamente dichiarato
  sotto `modes: dark:`.
- Mappatura completa della rampa Terracotta a 8 stop (`#3d405b` → `#f9f1de`) presa
  dalla palette omonima di `wallpapers.robertobonfa.com` (`js/app.js:126`).
- Accenti semantici: `#d62839` errore, `#f0a202` avviso, `#6a994e` successo,
...
- Sfondo minimale: sorgente `backgrounds/terracotta-bg.svg` più PNG 2560×1440
