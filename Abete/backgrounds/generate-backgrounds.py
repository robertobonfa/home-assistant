#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Abete a partire dalla stessa composizione di abete-bg.svg.
Generates the Abete background PNGs from the same composition as abete-bg.svg.
...
OUT = [
    ("abete-bg-2560x1440.png", 2560, 1440),
    ("abete-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Abete
SKY_TOP = hexrgb("#0e1a17")
SKY_MID = hexrgb("#101d1a")
SKY_BOT = hexrgb("#192c27")
GLOW = hexrgb("#426156")
COUNTERGLOW = hexrgb("#5d7e70")
RIDGE_1_TOP = hexrgb("#182b26")
RIDGE_1_BOT = hexrgb("#162723")
RIDGE_2 = hexrgb("#1a2f29")
EDGE = hexrgb("#2e4a41")
VIGNETTE = hexrgb("#0a1311")
