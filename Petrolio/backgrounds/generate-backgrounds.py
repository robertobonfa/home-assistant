#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Petrolio a partire dalla stessa composizione di petrolio-bg.svg.
Generates the Petrolio background PNGs from the same composition as petrolio-bg.svg.
...
OUT = [
    ("petrolio-bg-2560x1440.png", 2560, 1440),
    ("petrolio-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Petrolio
SKY_TOP = hexrgb("#102127")
SKY_MID = hexrgb("#12262c")
SKY_BOT = hexrgb("#1a353d")
GLOW = hexrgb("#417076")
COUNTERGLOW = hexrgb("#5d8d90")
RIDGE_1_TOP = hexrgb("#19343c")
RIDGE_1_BOT = hexrgb("#173037")
RIDGE_2 = hexrgb("#1b383f")
EDGE = hexrgb("#2c545c")
VIGNETTE = hexrgb("#0c191d")
