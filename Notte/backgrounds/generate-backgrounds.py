#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Notte a partire dalla stessa composizione di notte-bg.svg.
Generates the Notte background PNGs from the same composition as notte-bg.svg.
...
OUT = [
    ("notte-bg-2560x1440.png", 2560, 1440),
    ("notte-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Notte
SKY_TOP = hexrgb("#0a0b1d")
SKY_MID = hexrgb("#0b0d21")
SKY_BOT = hexrgb("#121635")
GLOW = hexrgb("#3a4494")
COUNTERGLOW = hexrgb("#5a6ac9")
RIDGE_1_TOP = hexrgb("#121533")
RIDGE_1_BOT = hexrgb("#10132e")
RIDGE_2 = hexrgb("#131737")
EDGE = hexrgb("#232a63")
VIGNETTE = hexrgb("#070815")
