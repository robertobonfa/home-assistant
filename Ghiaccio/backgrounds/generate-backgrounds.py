#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Ghiaccio a partire dalla stessa composizione di ghiaccio-bg.svg.
Generates the Ghiaccio background PNGs from the same composition as ghiaccio-bg.svg.
...
OUT = [
    ("ghiaccio-bg-2560x1440.png", 2560, 1440),
    ("ghiaccio-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Ghiaccio
SKY_TOP = hexrgb("#012541")
SKY_MID = hexrgb("#012a4a")
SKY_BOT = hexrgb("#01355c")
GLOW = hexrgb("#2c7da0")
COUNTERGLOW = hexrgb("#468faf")
RIDGE_1_TOP = hexrgb("#01345a")
RIDGE_1_BOT = hexrgb("#013155")
RIDGE_2 = hexrgb("#01375e")
EDGE = hexrgb("#014f86")
VIGNETTE = hexrgb("#011b30")
