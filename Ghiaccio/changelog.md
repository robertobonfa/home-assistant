...
- Gli interruttori accesi usavano `#61a5c2`, lo stesso colore dello stato
  ...
  `state-switch-active-color` passa a `#f5d06a`.
...
- Tema `ghiaccio.yaml` per Home Assistant, 185 variabili, interamente dichiarato
  sotto `modes: dark:`.
- Mappatura completa della rampa Ghiaccio a 8 stop (`#012a4a` → `#e8f7fa`) presa
  dalla palette omonima di `wallpapers.robertobonfa.com` (`js/app.js:136`).
- Accenti semantici: `#e5586a` errore, `#edb44f` avviso, `#5fc9a0` successo,
  `#f5d06a` per il dominio `light` attivo.
...
- Sfondo minimale: sorgente `backgrounds/ghiaccio-bg.svg` più PNG 2560×1440
