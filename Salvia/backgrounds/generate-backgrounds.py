#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Salvia a partire dalla stessa composizione di salvia-bg.svg.
Generates the Salvia background PNGs from the same composition as salvia-bg.svg.
...
OUT = [
    ("salvia-bg-2560x1440.png", 2560, 1440),
    ("salvia-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Salvia
SKY_TOP = hexrgb("#29363d")
SKY_MID = hexrgb("#2f3e46")
SKY_BOT = hexrgb("#3c5049")
GLOW = hexrgb("#6f9482")
COUNTERGLOW = hexrgb("#84a98c")
RIDGE_1_TOP = hexrgb("#3b5049")
RIDGE_1_BOT = hexrgb("#334741")
RIDGE_2 = hexrgb("#425a53")
EDGE = hexrgb("#52796f")
VIGNETTE = hexrgb("#1f2a30")
