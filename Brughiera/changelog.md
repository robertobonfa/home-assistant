...
- Gli interruttori accesi usavano `#a5a0c0`, lo stesso colore dello stato
  ...
  `state-switch-active-color` passa a `#ecc76d`.
...
- Tema `brughiera.yaml` per Home Assistant, 185 variabili, interamente dichiarato
  sotto `modes: dark:`.
- Mappatura completa della rampa Brughiera a 8 stop (`#26232e` → `#f0eef7`) presa
  dalla palette omonima di `wallpapers.robertobonfa.com` (`js/app.js:146`).
- Accenti semantici: `#cf6470` errore, `#ddab55` avviso, `#7fb98a` successo,
  `#ecc76d` per il dominio `light` attivo.
...
- Sfondo minimale: sorgente `backgrounds/brughiera-bg.svg` più PNG 2560×1440
