#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Brughiera a partire dalla stessa composizione di brughiera-bg.svg.
Generates the Brughiera background PNGs from the same composition as brughiera-bg.svg.
...
OUT = [
    ("brughiera-bg-2560x1440.png", 2560, 1440),
    ("brughiera-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Brughiera
SKY_TOP = hexrgb("#211f28")
SKY_MID = hexrgb("#26232e")
SKY_BOT = hexrgb("#353141")
GLOW = hexrgb("#6b6488")
COUNTERGLOW = hexrgb("#8781a5")
RIDGE_1_TOP = hexrgb("#343040")
RIDGE_1_BOT = hexrgb("#2f2c3a")
RIDGE_2 = hexrgb("#373344")
EDGE = hexrgb("#524d68")
VIGNETTE = hexrgb("#19171e")
...
def render(w, h):
    ...
    rng = np.random.default_rng(2623)
