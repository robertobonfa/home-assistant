#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Malva a partire dalla stessa composizione di malva-bg.svg.
Generates the Malva background PNGs from the same composition as malva-bg.svg.
...
OUT = [
    ("malva-bg-2560x1440.png", 2560, 1440),
    ("malva-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Malva
SKY_TOP = hexrgb("#261a23")
SKY_MID = hexrgb("#2b1d28")
SKY_BOT = hexrgb("#402c3c")
GLOW = hexrgb("#88627b")
COUNTERGLOW = hexrgb("#a67f95")
RIDGE_1_TOP = hexrgb("#3e2b3a")
RIDGE_1_BOT = hexrgb("#382735")
RIDGE_2 = hexrgb("#432f3e")
EDGE = hexrgb("#684a5f")
VIGNETTE = hexrgb("#1c131a")
