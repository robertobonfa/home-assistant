#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Lavanda a partire dalla stessa composizione di lavanda-bg.svg.
Generates the Lavanda background PNGs from the same composition as lavanda-bg.svg.
...
OUT = [
    ("lavanda-bg-2560x1440.png", 2560, 1440),
    ("lavanda-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Lavanda
SKY_TOP = hexrgb("#1f163a")
SKY_MID = hexrgb("#231942")
SKY_BOT = hexrgb("#35265b")
GLOW = hexrgb("#7d6ba0")
COUNTERGLOW = hexrgb("#9f86c0")
RIDGE_1_TOP = hexrgb("#342559")
RIDGE_1_BOT = hexrgb("#2f2252")
RIDGE_2 = hexrgb("#38285f")
EDGE = hexrgb("#5e548e")
VIGNETTE = hexrgb("#17102b")
