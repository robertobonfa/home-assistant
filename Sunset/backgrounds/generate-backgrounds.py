#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Sunset a partire dalla stessa composizione di sunset-bg.svg.
Generates the Sunset background PNGs from the same composition as sunset-bg.svg.
...
OUT = [
    ("sunset-bg-2560x1440.png", 2560, 1440),
    ("sunset-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Sunset
SKY_TOP = hexrgb("#1a0f2f")
SKY_MID = hexrgb("#1d1135")
SKY_BOT = hexrgb("#4a1f57")
GLOW = hexrgb("#ff9770")
COUNTERGLOW = hexrgb("#ee6c6b")
RIDGE_1_TOP = hexrgb("#3b1950")
RIDGE_1_BOT = hexrgb("#321647")
RIDGE_2 = hexrgb("#421b56")
EDGE = hexrgb("#883677")
VIGNETTE = hexrgb("#130b22")
