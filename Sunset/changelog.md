...
- Gli interruttori accesi usavano `#ff9770`, lo stesso colore dello stato
  ...
  `state-switch-active-color` passa a `#4cc9f0`.
...
- Anche `state-light-active-color` passa a `#4cc9f0`: su una rampa gia calda
