#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Oceano a partire dalla stessa composizione di oceano-bg.svg.
Generates the Oceano background PNGs from the same composition as oceano-bg.svg.
...
OUT = [
    ("oceano-bg-2560x1440.png", 2560, 1440),
    ("oceano-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Oceano
SKY_TOP = hexrgb("#001016")
SKY_MID = hexrgb("#001219")
SKY_BOT = hexrgb("#012a38")
GLOW = hexrgb("#0a9396")
COUNTERGLOW = hexrgb("#52b69a")
RIDGE_1_TOP = hexrgb("#012936")
RIDGE_1_BOT = hexrgb("#01222d")
RIDGE_2 = hexrgb("#022e3c")
EDGE = hexrgb("#005f73")
VIGNETTE = hexrgb("#000c10")
