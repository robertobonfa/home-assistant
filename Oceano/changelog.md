...
- Gli interruttori accesi usavano `#94d2bd`, lo stesso colore dello stato
  ...
  `state-switch-active-color` passa a `#f2cd5e`.
...
- Tema `oceano.yaml` per Home Assistant, 185 variabili, interamente dichiarato
  sotto `modes: dark:`.
- Mappatura completa della rampa Oceano a 8 stop (`#001219` → `#f1f7ee`) presa
  dalla palette omonima di `wallpapers.robertobonfa.com` (`js/app.js:124`).
- Accenti semantici: `#e0565b` errore, `#edb14b` avviso, `#86d16d` successo,
  `#f2cd5e` per il dominio `light` attivo.
...
- Sfondo minimale: sorgente `backgrounds/oceano-bg.svg` più PNG 2560×1440
