#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Nordic a partire dalla stessa composizione di nordic-bg.svg.
Generates the Nordic background PNGs from the same composition as nordic-bg.svg.
...
OUT = [
    ("nordic-bg-2560x1440.png", 2560, 1440),
    ("nordic-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Nordic
SKY_TOP = hexrgb("#272c36")
SKY_MID = hexrgb("#2e3440")
SKY_BOT = hexrgb("#39404e")
GLOW = hexrgb("#5e81ac")
COUNTERGLOW = hexrgb("#81a1c1")
RIDGE_1_TOP = hexrgb("#363d4c")
RIDGE_1_BOT = hexrgb("#343a48")
RIDGE_2 = hexrgb("#383f4e")
EDGE = hexrgb("#4c566a")
VIGNETTE = hexrgb("#20242c")
...
def render(w, h):
    ...
    rng = np.random.default_rng(3440)
