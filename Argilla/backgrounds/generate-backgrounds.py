#!/usr/bin/env python3
"""
Genera i PNG dello sfondo Argilla a partire dalla stessa composizione di argilla-bg.svg.
Generates the Argilla background PNGs from the same composition as argilla-bg.svg.
...
OUT = [
    ("argilla-bg-2560x1440.png", 2560, 1440),
    ("argilla-bg-1170x2532.png", 1170, 2532),
]
...
# Palette Argilla
SKY_TOP = hexrgb("#261713")
SKY_MID = hexrgb("#2b1a16")
SKY_BOT = hexrgb("#422820")
GLOW = hexrgb("#8d5c48")
COUNTERGLOW = hexrgb("#a97862")
RIDGE_1_TOP = hexrgb("#402720")
RIDGE_1_BOT = hexrgb("#3a231d")
RIDGE_2 = hexrgb("#452a22")
EDGE = hexrgb("#6d4536")
VIGNETTE = hexrgb("#1c110e")
