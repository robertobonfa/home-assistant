...
- Gli interruttori accesi usavano `#c69a82`, lo stesso colore dello stato
  ...
  `state-switch-active-color` passa a `#4fb3d9`.
...
- Anche `state-light-active-color` passa a `#4fb3d9`: su una rampa gia calda
